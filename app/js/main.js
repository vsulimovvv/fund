...
function projects() {
  ...
  slider.forEach(el => {
    const swiper3 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](el, {
      slidesPerView: 1,
      navigation: {
...
/* harmony import */ var _components_formUpload__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/formUpload */ "./src/js/components/formUpload.js");
...
(0,_components_tabs__WEBPACK_IMPORTED_MODULE_1__["default"])(".donation-block__top", ".donation-block__btn", ".donation-block__content", "active");
(0,_components_tabs__WEBPACK_IMPORTED_MODULE_1__["default"])(".tabs-projects__nav", ".tabs-projects__nav-btn", ".tabs-projects__panel", "active"); // function maskInput() {
...
element.forEach(el => {
  const choices = new (choices_js__WEBPACK_IMPORTED_MODULE_2___default())(el, {
    itemSelectText: "",
    searchEnabled: false
  });
});
...
(0,_components_formUpload__WEBPACK_IMPORTED_MODULE_4__["default"])();
(0,_components_slider__WEBPACK_IMPORTED_MODULE_0__.projects)();
})();
